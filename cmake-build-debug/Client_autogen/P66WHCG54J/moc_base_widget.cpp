...
void BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (BaseWidget::*)()>(_a, &BaseWidget::back, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (BaseWidget::*)(const OutMessage & )>(_a, &BaseWidget::sendMessage, 3))
            return;
    }
}
...
// SIGNAL 3
void BaseWidget::sendMessage(const OutMessage & _t1)
{
