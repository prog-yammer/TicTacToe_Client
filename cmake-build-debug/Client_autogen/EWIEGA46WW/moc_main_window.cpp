...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'forward'
        QtMocHelpers::SlotData<void(BaseWidget *, bool)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 7, 8 }, { QMetaType::Bool, 9 },
        }}),
        // Slot 'forward'
        QtMocHelpers::SlotData<void(BaseWidget *)>(6, 2, QMC::AccessPrivate | QMC::MethodCloned, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
        // Slot 'back'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onSendMessage'
        QtMocHelpers::SlotData<void(const OutMessage &)>(11, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 12, 4 },
        }}),
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->forward((*reinterpret_cast< std::add_pointer_t<BaseWidget*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        case 3: _t->forward((*reinterpret_cast< std::add_pointer_t<BaseWidget*>>(_a[1]))); break;
        case 4: _t->back(); break;
        case 5: _t->onSendMessage((*reinterpret_cast< std::add_pointer_t<OutMessage>>(_a[1]))); break;
