...
#include "../../../src/common/websocket_worker.h"
...
void WebSocketWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->statusUpdate((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WebSocketWorker::*)(const QString & )>(_a, &WebSocketWorker::messageReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (WebSocketWorker::*)(bool )>(_a, &WebSocketWorker::statusUpdate, 1))
            return;
    }
}
...
// SIGNAL 1
void WebSocketWorker::statusUpdate(bool _t1)
{
